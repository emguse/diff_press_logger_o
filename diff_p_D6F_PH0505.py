...
class DifferentialPressureSensorD6F_PH0505():
    ...
    def read(self):
        ...
        - After reading the raw data, the conversion is performed and the differential pressure value is stored in the variable 'diff_p'.
